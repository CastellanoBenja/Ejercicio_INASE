...
class ResultadosController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Resultados->save($resultado)) {
                $this->Flash->success(__('El resultado se agregó correctamente.'));
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            $resultado = $this->Resultados->patchEntity($resultado, $this->request->getData());
            if ($this->Resultados->save($resultado)) {
                $this->Flash->success(__('El resultado fue editado correctamente.'));
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Resultados->delete($resultado)) {
            $this->Flash->success(__('El resultado se elimino correctamente.'));
        } else {
            $this->Flash->error(__('El resultado no se pudo eliminar. Por favor, inténtelo nuevamente.'));
        }
